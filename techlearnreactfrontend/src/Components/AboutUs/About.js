    ...
    render(){
        return (
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title text-black">Taranjeet Singh Saluja</h5>
    ...
    render()
    {
        return (
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title text-black">Mohit Singh</h5>
...
class Author3 extends React.Component{
    render()
    {
        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    <h5 class="card-title text-black">Soumik Chakraborty</h5>
    ...
    render()
    {
        return (
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title text-black">Piyush Kumar Singh</h5>
    ...
    render()
    {
        return (
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title text-black">Rohit Kulshrestha</h5>
...
class Author6 extends React.Component{
    ...
    return (
        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    <h5 class="card-title text-black">Sayan Chatterjee</h5>
    ...
    render()
    {
        return (
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title text-black">Divyansh Kaushik</h5>
